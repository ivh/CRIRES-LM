...
the tightest constraint, with a median per-group RMS of 250\,m\,s$^{-1}$
across 206 well-behaved groups. Since each A--B difference combines the
noise of two independent fits, the implied single-fit precision is
$250 / \sqrt{2} \approx 177$\,m\,s$^{-1}$.  The inter-chip and
inter-order gap metrics give median RMS values of 294 and
...
\begin{figure*}
  ...
  \caption{Wavelength precision of the \vipere{} fits to science spectra,
    ...
    tightest metric (median 250\,m\,s$^{-1}$).
...
table wavelength polynomial.  Across 201 (setting, chip, order) groups
the residuals between the measured and predicted A--B shifts have an RMS
of 808\,m\,s$^{-1}$ and a median offset of only 15\,m\,s$^{-1}$
...
\begin{figure}
  ...
  \caption{Residual between the measured median A--B wavelength shift and
    ...
    respectively.  The RMS residual of 808\,m\,s$^{-1}$ is consistent
    with the single-fit wavelength precision of ${\sim}180$\,m\,s$^{-1}$

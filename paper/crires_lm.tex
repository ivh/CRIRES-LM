...
fitted segment in all 1924 science observations with at least one order
...
the tightest constraint, with a median per-group RMS of 938\,m\,s$^{-1}$
across 137 well-behaved groups. Since each A--B difference combines the
noise of two independent fits, the implied single-fit precision is
$938 / \sqrt{2} \approx 660$\,m\,s$^{-1}$.  The inter-chip and
inter-order gap metrics give median RMS values of 1234 and
1461\,m\,s$^{-1}$, respectively, while the absolute wavelength
...
${\sim}3$\,\kms. These results apply to orders with sufficient telluric
...
\begin{figure*}
  ...
  \caption{Wavelength precision of the \vipere{} fits to science spectra,
    ...
    tightest metric (median 938\,m\,s$^{-1}$).
